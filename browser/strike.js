...
const generateWarningLight = (hexCode, strikes) => (<Entity strikes={strikes} id="warningLight" position="0 5.3 0.4" primitive="a-cone" geometry={{radiusBottom: 0.21, radiusTop: 0.33, height: 0.3}} opacity="0.4" transparent animation={{property: 'material.color', from: '#000', to: `${hexCode}`, ease: 'linear', loop: 'true', direction: 'ease-in'}}>
