...
export default function Rules(props) {
  return (
    <div>
    <Col l={12}>Panel 1</Col>
    <br/>
    <div className="module">
      <Col l={12} className="moduleName">Module Name: Nanomatronic Kilowasher</Col>
      <Table>
        <thead>
          <tr>
    ...
    <div className="module">
       <Col l={12} className="moduleName">Module Name: Gravitron Emitter</Col>
        <Table>
          <thead>
            <tr>
              <th data-field="id">Type of Widget</th>
